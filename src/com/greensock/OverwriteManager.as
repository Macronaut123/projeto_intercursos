 ...
 * TweenLite, TimelineLite, or TimelineMax. This keeps things small and fast. However, it isn't ideal for 
 ...
 * the default whenever TweenLite, TimelineLite, or TimelineMax is used in your swf. OverwriteManager
 ...
 * 					</ol>
 * 					This is the default mode for TweenLite unless TweenLite, TimelineLite, 
 ...
 * 					</ol>
 * 					This is the default mode when TweenLite, TimelineLite, or TimelineMax is used in your swf (those classes
 ...
 * 
 * 		TweenLite.to(mc, 1, {x:100, overwrite:OverwriteManager.PREXISTING});<br />
 * 		TweenLite.to(mc, 1, {x:100, overwrite:5});<br /><br /></code>
 * 
 ...
 * However, TweenLite, TimelineLite, and TimelineMax automatically init() OverwriteManager in <code>AUTO</code> mode 
 ...
 * the default OverwriteManager mode will affect TweenLite and TweenLite tweens.<br /><br />
 * 		
 * 
 * <b>EXAMPLES:</b><br /><br /> 
 * 
 ...
 */	 
	final public class OverwriteManager {
		...
		/** Only overwrites individual overlapping tweening properties in other tweens of the same target. TweenLite, TimelineLite, and TimelineMax automatically init() OverwriteManager in this mode if you haven't already called OverwriteManager.init(). **/
		...
		/** The default overwrite mode for all TweenLite and TweenLite instances **/
