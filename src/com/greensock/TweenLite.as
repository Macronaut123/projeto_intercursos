 ...
 * 		  	 hex colors, volume, tint, frames, and even do bezier tweening, plus LOTS more. TweenLite extends 
 ...
 * 													
 * 											<li>AUTO (2) - this is the default mode if TweenLite, TimelineLite, or TimelineMax is used in the swf. (these classes automatically init() OverwriteManager if you haven't done so already)</li>
 * 												
 ...
 */	 
	public class TweenLite extends TweenCore {
		...
		public function TweenLite(target:Object, duration:Number, vars:Object) {
			...
			//handle overwriting (if necessary) on tweens of the same object and add the tween to the Dictionary for future reference. Also remember to accommodate TweenLiteVars and TweenLiteVars
