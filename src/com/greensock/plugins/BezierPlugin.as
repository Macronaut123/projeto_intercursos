 ...
 */
	public class BezierPlugin extends TweenPlugin {
		...
		protected function init(tween:TweenLite, beziers:Array, through:Boolean):void {
			...
			var enumerables:Object = (tween.vars.isTV == true) ? tween.vars.exposedVars : tween.vars; //for TweenLiteVars and TweenLiteVars (we need an object with enumerable properties);
