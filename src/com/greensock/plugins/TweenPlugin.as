...
/**
 * TweenPlugin is the base class for all TweenLite/TweenLite plugins. <br /><br />
 * 	
 * <b>USAGE:</b><br />
 * 
 ...
 * 		  rounded to the nearest integer (compatible with TweenLite only). If you use the _tweens Array, populating
 ...
 */
	public class TweenPlugin {
		 ...
		 * @param tween The TweenLite or TweenLite instance using this plugin.
