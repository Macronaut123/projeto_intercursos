...
/**
 * TweenLite (AS3 only) has built-in algorithms that speed up the processing of certain easing equations but in order
 ...
 * 		TweenLite.to(mc, 2, {x:200, ease:Linear.easeNone});<br /><br />
 * </code>
 * 
