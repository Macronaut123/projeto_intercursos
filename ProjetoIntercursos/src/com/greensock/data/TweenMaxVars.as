...
//---- BUILT-IN SPECIAL PROPERTIES (NO PLUGIN ACTIVATION REQUIRED) --------------------------------------------------------------
		...
		/** A function to which the TweenLite instance should dispatch a TweenEvent when it completes. This is the same as doing myTween.addEventListener(TweenEvent.COMPLETE, myFunction); **/
		public function onCompleteListener(func:Function):TweenLiteVars {
		...
		/** A function to which the TweenLite instance should dispatch a TweenEvent when it begins. This is the same as doing <code>myTween.addEventListener(TweenEvent.START, myFunction);</code> **/
		public function onStartListener(func:Function):TweenLiteVars {
		...
		/** A function to which the TweenLite instance should dispatch a TweenEvent every time it updates values. This is the same as doing myTween.addEventListener(TweenEvent.UPDATE, myFunction); **/
		public function onUpdateListener(func:Function):TweenLiteVars {
		 ...
		 **/
		public function onRepeat(func:Function, params:Array=null):TweenLiteVars {
		...
		/**  A function to which the TweenLite instance should dispatch a TweenEvent when it has reached its starting point again after having been reversed **/
		public function onReverseCompleteListener(func:Function):TweenLiteVars {
		...
		public function repeat(value:int):TweenLiteVars {
			return _set("repeat", value);
		}
		
		/** Amount of time in seconds (or frames for frames-based tween) between repeats. **/
		public function repeatDelay(value:Number):TweenLiteVars {
		 ...
		 **/
		public function reversed(value:Boolean):TweenLiteVars {
		...
		public function timeScale(value:Number):TweenLiteVars {
		...
		/** Allows you to define the starting values for properties. It is the same as defining the "from" parameter in a <code>TweenLite.fromTo()</code> call. **/
		public function startAt(vars:TweenLiteVars):TweenLiteVars {
		 ...
		 **/
		public function yoyo(value:Boolean):TweenLiteVars {
...
//---- PLUGIN REQUIRED -------------------------------------------------------------------------------------------
		 ...
		 * 		import com.greensock.data.TweenLiteVars; <br /><br />
		 * 
		 ...
		 * TweenLite will use a typical setup, <code>[["x", "y", "rotation", 0]]</code>. 
		...
		public function roundProps(propertyNames:Array):TweenLiteVars {
