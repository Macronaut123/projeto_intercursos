 ...
 * 	TweenLite, TweenLite, TimelineLite, and/or TimelineMax instances. You can think of a TimelineLite instance 
 ...
 * 	
 * 		var myTimeline:TimelineLite = new TimelineLite({tweens:[new TweenLite(mc1, 1, {y:"100"}), TweenLite.to(mc2, 1, {tint:0xFF0000})], align:TweenAlign.SEQUENCE, onComplete:myFunction});</code><br /><br />
 * 	
 ...
 **/
	public class TimelineLite extends SimpleTimeline {
		 ...
		 * 										to pass in an Array of TweenLite/TweenLite/TimelineLite/TimelineMax instances. You can use this in conjunction
		...
		/**
		 * Removes a TweenLite, TweenLite, TimelineLite, or TimelineMax instance from the timeline.
		 * 
		 * @param tween TweenLite, TweenLite, TimelineLite, or TimelineMax instance to remove
		...
		/**
		 * Inserts a TweenLite, TweenLite, TimelineLite, or TimelineMax instance into the timeline at a specific time, frame, or label. 
		 ...
		 * 
		 * @param tween TweenLite, TweenLite, TimelineLite, or TimelineMax instance to insert
		 ...
		 * @return TweenLite, TweenLite, TimelineLite, or TimelineMax instance that was inserted
		 */
		...
		/**
		 * Inserts a TweenLite, TweenLite, TimelineLite, or TimelineMax instance at the <strong>end</strong> of the timeline,
		 ...
		 * 
		 * @param tween TweenLite, TweenLite, TimelineLite, or TimelineMax instance to append.
		 ...
		 * @return TweenLite, TweenLite, TimelineLite, or TimelineMax instance that was appended 
		 */
		...
		/**
		 * Inserts a TweenLite, TweenLite, TimelineLite, or TimelineMax instance at the beginning of the timeline,
		 ...
		 * 
		 * @param tween TweenLite, TweenLite, TimelineLite, or TimelineMax instance to prepend
		 ...
		 * @return TweenLite, TweenLite, TimelineLite, or TimelineMax instance that was prepended
		 */
		 ...
		 *  
		 * @param tweens an Array containing any or all of the following: TweenLite, TweenLite, TimelineLite, and/or TimelineMax instances  
		 ...
		 * @param tweens determines whether or not tweens (TweenLite and TweenLite instances) should be included in the results
		 ...
		 * @return an Array of TweenLite and TweenLite instances
		 */
