...
/**
 * TweenCore is the base class for all TweenLite, TweenLite, TimelineLite, and TimelineMax classes and 
 ...
 */
	public class TweenCore {
		 ...
		 * have a <code>TweenLite(mc, 1, {x:100, y:100})</code> that ran when mc.x and mc.y were initially at 0, but now mc.x 
...
//---- GETTERS / SETTERS ------------------------------------------------------------
		...
		public function set duration(n:Number):void {
			...
			setDirtyCache(true); //true in case it's a TweenLite or TimelineMax that has a repeat - we'll need to refresh the totalDuration. 
		 ...
		 * or repeatDelays (which are only available on TweenLite and TimelineMax). <code>duration</code>, by contrast, does 
		 * <b>NOT</b> include repeats and repeatDelays. So if a TweenLite's <code>duration</code> is 1 and it has a repeat of 2, 
		 ...
		 * and <code>totalTime</code> will always be the same but in TweenLite or TimelineMax, they 
