...
package com.greensock {
	...
	import flash.utils.*;
/**
 * 	TweenLite extends the extremely lightweight, fast TweenLite engine, adding many useful features
 * 	like timeScale, event dispatching, updateTo(), yoyo, repeat, repeatDelay, rounding, and more. It also 
 * 	activates many extra plugins by default, making it extremely full-featured. Since TweenLite extends 
 * 	TweenLite, it can do ANYTHING TweenLite can do plus much more. The syntax is identical. With plenty 
 *  of other tweening engines to choose from, here's why you might want to consider TweenLite: 
 * 
 * <ul>
 ...
 * 										several modes to choose from, and TweenLite automatically calls <code>OverwriteManager.init()</code> if you haven't
 ...
 * 													
 * 											<li>AUTO (2) - this is the default mode for TweenLite.</li>
 * 												
 * 											<li>CONCURRENT (3)</li>
 * 												
 * 											<li>ALL_ONSTART (4)</li>
 ...
 * 									
 * 	<li><b> onStartListener : Function</b>		A function to which the TweenLite instance should dispatch a TweenEvent when it begins.
 * 	  											This is the same as doing <code>myTween.addEventListener(TweenEvent.START, myFunction);</code></li>
 * 	
 * 	<li><b> onUpdateListener : Function</b>		A function to which the TweenLite instance should dispatch a TweenEvent every time it 
 * 												updates values.	This is the same as doing <code>myTween.addEventListener(TweenEvent.UPDATE, myFunction);</code></li>
 * 	  
 * 	<li><b> onCompleteListener : Function</b>	A function to which the TweenLite instance should dispatch a TweenEvent when it completes.
 * 	  											This is the same as doing <code>myTween.addEventListener(TweenEvent.COMPLETE, myFunction);</code></li>
 * 
 *  <li><b> onReverseCompleteListener : Function</b> A function to which the TweenLite instance should dispatch a TweenEvent when it completes
 ...
 * 
 *  <li><b> onRepeatListener : Function</b>		A function to which the TweenLite instance should dispatch a TweenEvent when it repeats.
 * 	  											This is the same as doing <code>myTween.addEventListener(TweenEvent.REPEAT, myFunction);</code></li>
 * 	
 * 	<li><b> startAt : Object</b>				Allows you to define the starting values for each property. Typically, TweenLite uses the current
 ...
 * 												tween it from 0 to 500, do <code>TweenLite.to(mc, 2, {x:500, startAt:{x:0}});</code> </li>
 * </ul>
 * 
 ...
 * 	Get information about all the plugins at <a href="http://www.TweenLite.com">http://www.TweenLite.com</a>. The 
 *  following plugins are activated by default in TweenLite (you can easily prevent them from activating, thus 
 ...
 * 					  			  to end up at(or begin at if you're using TweenLite.from()). An example hex value would be 0xFF0000.</li>
 * 					  
 ...
 * 					   			  <code>TweenLite.to(my_mc, 3, {bezier:[{x:250, y:50}, {x:500, y:0}]});</code></li>
 * 					   
 ...
 * 							makes it easy. In order to alter a rotation property accurately, TweenLite needs 4 pieces
 * 							of information: 
 * 							<ol>
 ...
 * 							in a boolean value of true and TweenLite will use a typical setup, <code>[["x", "y", "rotation", 0]]</code>. 
 ...
 * 				 blue components must be extracted and tweened independently. TweenLite makes it easy. To tween
 * 				 a property of your object that's a hex color to another hex color, use this special hexColors 
 * 				 property of TweenLite. It must be an OBJECT with properties named the same as your object's 
 ...
 * 				 <code>TweenLite.to(my_obj, 2, {hexColors:{myHexColor:0xFF0000}});</code><br />
 ...
 * 	  					   every time the tween is rendered, you'd do: <code>TweenLite.to(mc, 2, {x:300, y:200, alpha:0.5, roundProps:["x","y"]});</code></li>
 * 	  					   
 ...
 * 	  var myTween:TweenLite = new TweenLite(my_mc, 2, {x:200});<br />
 * 	  myTween.addEventListener(TweenEvent.COMPLETE, myFunction);</code></li>
 * 	  
 * 	<li> You can kill all tweens of a particular object anytime with the <code>TweenLite.killTweensOf(myObject); </code></li>
 * 	  
 ...
 */
	public class TweenLite extends TweenLite implements IEventDispatcher {
		/** @private **/
		...
		TweenPlugin.activate([
			...
			RoundPropsPlugin,			//enables the roundProps special property for rounding values (ONLY for TweenLite!)
		...
		public function TweenLite(target:Object, duration:Number, vars:Object) {
			...
			if (TweenLite.version < 11.2) {
				throw new Error("TweenLite error! Please update your TweenLite class or try deleting your ASO files. TweenLite requires a more recent version. Download updates at http://www.TweenLite.com.");
			}
		...
		override protected function init():void {
			if (this.vars.startAt) {
				...
				var startTween:TweenLite = new TweenLite(this.target, 0, this.vars.startAt);
			}
			if (_dispatcher) {
		 ...
		 * 
		 * //create the tween <br />
		 * var tween:TweenLite = new TweenLite(mc, 2, {x:100, y:200, alpha:0.5});<br /><br />
		 * 
		...
		override public function renderTime(time:Number, suppressEvents:Boolean=false, force:Boolean=false):void {
			...
			if (time >= totalDur) {
				...
				} else if (time == 0 && !this.initted) { //if we render the very beginning (time == 0) of a TweenLite.fromTo(), we must force the render (normal tweens wouldn't need to render at a time of 0 when the prevTime was also 0). This is also mandatory to make sure overwriting kicks in immediately.
					force = true;
				}
...
//---- STATIC FUNCTIONS -----------------------------------------------------------------------------------------------------------
		 ...
		 * 		var myTween:TweenLite = TweenLite.to(mc, 1, {x:100}); <br /><br /></code>
		 * 
		 * @param target Target object whose properties this tween affects. This can be ANY object, not just a DisplayObject. 
		 ...
		 * compared to a <code>TweenLite.to()</code> tween. In other words, you define the START values in the 
		 ...
		 * because you can build them in their end positions and do some simple <code>TweenLite.from()</code>
		...
		public static function from(target:Object, duration:Number, vars:Object):TweenLite {
			if (vars.isGSVars) {  //to accommodate TweenLiteVars instances for strong data typing and code hinting
				vars = vars.vars;
			}
		...
		/**
		 * Static method for creating a TweenLite instance that tweens from a particular set of
		...
		public static function fromTo(target:Object, duration:Number, fromVars:Object, toVars:Object):TweenLite {
			if (toVars.isGSVars) {  //to accommodate TweenLiteVars instances for strong data typing and code hinting
				toVars = toVars.vars;
			}
			if (fromVars.isGSVars) {  //to accommodate TweenLiteVars instances for strong data typing and code hinting
		 ...
		 * 
		 * TweenLite.allTo([mc1, mc2, mc3, mc4, mc5], 1, {y:"100", alpha:0}, 0.2); <br /><br /></code>
		 * 
		 ...
		 * <code>myTimeline.insertMultiple(TweenLite.allTo([mc1, mc2, mc3], 1, {alpha:0, y:"100"}, 0.1));</code>
		 * 
		 ...
		 * @param vars An object containing the end values of all the properties you'd like to have tweened (or if you're using the TweenLite.allFrom() method, these variables would define the BEGINNING values).
		 * @param stagger Staggers the start time of each tween. For example, you might want to have 5 MovieClips move down 100 pixels while fading out, and stagger the start times slightly by 0.2 seconds, you could do: <code>TweenLite.allTo([mc1, mc2, mc3, mc4, mc5], 1, {y:"100", alpha:0}, 0.2)</code>.
		 ...
		 * @return Array of TweenLite tweens
		 */
		public static function allTo(targets:Array, duration:Number, vars:Object, stagger:Number=0, onCompleteAll:Function=null, onCompleteAllParams:Array=null):Array {
			...
			for (i = 0; i < l; i += 1) {
				...
				a[i] = new TweenLite(targets[i], duration, varsDup);
				curDelay += stagger;
			}
			return a;
		}
		...
		/**
		 * Exactly the same as TweenLite.allTo(), but instead of tweening the properties from where they're 
		 ...
		 * 
		 * TweenLite.allFrom([mc1, mc2, mc3], 1.5, {alpha:0, delay:2}, 0.1);</code>
		 * 
		 * @param targets An Array of objects to tween.
		 ...
		 * @param stagger Staggers the start time of each tween. For example, you might want to have 5 MovieClips move down 100 pixels while fading from alpha:0, and stagger the start times slightly by 0.2 seconds, you could do: <code>TweenLite.allFromTo([mc1, mc2, mc3, mc4, mc5], 1, {y:"-100", alpha:0}, 0.2)</code>.
		 * @param onCompleteAll A function to call when all of the tweens have completed.
		 * @param onCompleteAllParams An Array of parameters to pass the onCompleteAll function when all the tweens have completed.
		 * @return Array of TweenLite instances
		 */
		 ...
		 * as TweenLite.allTo(), but adds the ability to define the starting values. <b>NOTE</b>: Only put starting values
		 * in the fromVars parameter - all special properties for the tween (like onComplete, onUpdate, delay, etc.) belong
		 * in the toVars parameter. 
		 * 
		 * @param targets An Array of objects to tween.
		 ...
		 * @param stagger Staggers the start time of each tween. For example, you might want to have 5 MovieClips move down from y:0 to y:100 while fading from alpha:0 to alpha:1, and stagger the start times slightly by 0.2 seconds, you could do: <code>TweenLite.allFromTo([mc1, mc2, mc3, mc4, mc5], 1, {y:0, alpha:0}, {y:100, alpha:1}, 0.2)</code>.
		 * @param onCompleteAll A function to call when all of the tweens have completed.
		 * @param onCompleteAllParams An Array of parameters to pass the onCompleteAll function when all the tweens have completed.
		 * @return Array of TweenLite instances
		 */
		 ...
		 * @return Array of tweens (could be TweenLite and/or TweenLite instances)
		 */
		 ...
		 * 
		 * @return Array of TweenLite and/or TweenLite instances
		 */
...
//---- GETTERS / SETTERS ----------------------------------------------------------------------------------------------------------
		 ...
		 * Value between 0 and 1 indicating the progress of the tween according to its <code>duration</code> 
 		 ...
 		 * which includes repeats and repeatDelays (if there are any). For example, if a TweenLite instance 
		 ...
		 * Value between 0 and 1 indicating the overall progress of the tween according to its <code>totalDuration</code>
 		 ...
 		 * include repeats and repeatDelays. For example, if a TweenLite instance is set to repeat 
		 ...
		 * For example, if a TweenLite instance has a duration of 5 a repeat of 1 (meaning its 
